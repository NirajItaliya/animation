package com.example.animation.cardslider;
...
import com.example.animation.cardslider.cards.SliderAdapter;
import com.example.animation.cardslider.utils.DecodeBitmapTask;
import com.example.libraries.cardslider.CardSliderLayoutManager;
import com.example.libraries.cardslider.CardSnapHelper;

import java.util.Random;

public class cardSlider extends AppCompatActivity {
    ...
    private void onActiveCardChange(int pos) {
        ...
        temperatureSwitcher.setInAnimation(cardSlider.this, animH[0]);
        temperatureSwitcher.setOutAnimation(cardSlider.this, animH[1]);
        temperatureSwitcher.setText(temperatures[pos % temperatures.length]);

        placeSwitcher.setInAnimation(cardSlider.this, animV[0]);
        placeSwitcher.setOutAnimation(cardSlider.this, animV[1]);
        placeSwitcher.setText(places[pos % places.length]);

        clockSwitcher.setInAnimation(cardSlider.this, animV[0]);
        clockSwitcher.setOutAnimation(cardSlider.this, animV[1]);
    ...
    private class TextViewFactory implements ViewSwitcher.ViewFactory {
        ...
        public View makeView() {
            final TextView textView = new TextView(cardSlider.this);
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                textView.setTextAppearance(cardSlider.this, styleId);
            } else {
    ...
    private class ImageViewFactory implements ViewSwitcher.ViewFactory {
        @Override
        public View makeView() {
            final ImageView imageView = new ImageView(cardSlider.this);
    ...
    private class OnCardClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (clickedPosition == activeCardPosition) {
                final Intent intent = new Intent(cardSlider.this, DetailsActivity.class);
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    final ActivityOptions options = ActivityOptions
                            .makeSceneTransitionAnimation(cardSlider.this, sharedView, "shared");
