...
public class ShimmerLayout1 extends FrameLayout {
    ...
    public ShimmerLayout1(Context context) {
        this(context, null);
    }

    public ShimmerLayout1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ShimmerLayout1(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.ShimmerLayout1,
                0, 0);

        try {
            shimmerAngle = a.getInteger(R.styleable.ShimmerLayout1_shimmer_angle, DEFAULT_ANGLE);
            shimmerAnimationDuration = a.getInteger(R.styleable.ShimmerLayout1_shimmer_animation_duration, DEFAULT_ANIMATION_DURATION);
            shimmerColor = a.getColor(R.styleable.ShimmerLayout1_shimmer_color, getColor(R.color.shimmer_color));
            autoStart = a.getBoolean(R.styleable.ShimmerLayout1_shimmer_auto_start, false);
            maskWidth = a.getFloat(R.styleable.ShimmerLayout1_shimmer_mask_width, 0.5F);
            gradientCenterColorWidth = a.getFloat(R.styleable.ShimmerLayout1_shimmer_gradient_center_color_width, 0.1F);
            isAnimationReversed = a.getBoolean(R.styleable.ShimmerLayout1_shimmer_reverse_animation, false);
        } finally {
            a.recycle();
        }
