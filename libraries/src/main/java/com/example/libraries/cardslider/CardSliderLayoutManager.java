package com.example.libraries.cardslider;
...
public class CardSliderLayoutManager extends RecyclerView.LayoutManager
    ...
    private ViewUpdater loadViewUpdater(Context context, String className, AttributeSet attrs) {
        ...
        try {
            ...
            final Class<? extends ViewUpdater> viewUpdaterClass = classLoader.loadClass(fullClassName).asSubclass(ViewUpdater.class);
            final Constructor<? extends ViewUpdater> constructor = viewUpdaterClass.getConstructor();
